...
if (isset($_POST['submit'])){
   ...
   echo "<script> alert('Device registered successfully'); </script>";

    } else {


           echo "<script> alert('Device not registered'); </script>";
                            ...
                            <div class="shadow" style="width: 100%;min-height: 630px;margin-top: 119px;background-color: rgba(255,255,255,0.79);">
                                <form style="padding-top: 70px;" method="post">
                                    <div class="form-group">
                                        <h1 class="text-center">Add a New Device</h1>
                                    </div>
                                    <div class="form-group"><input class="form-control form-control-lg" type="text" style="width: 50%;margin-left: 25%;" name="Device_name" placeholder="Device Name" required></div>
                                    <div class="form-group"><input class="form-control form-control-lg" type="text" style="width: 50%;margin-left: 25%;" name="Office_name" placeholder="Office Name"></div>
                                    <div class="form-group"><input class="form-control form-control-lg" type="tel" style="width: 50%;margin-left: 25%;" name="Model_name" placeholder="Model Name" required></div>
                                    <div class="form-group"><input class="form-control form-control-lg" type="datetime-local" style="width: 50%;margin-left: 25%;" name="Last_date_checked" placeholder="Last Date Checked" required></div>
